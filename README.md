...
- The Configure page, showing the detailed options available for recording...(v1.14)
...
### Videos
- In v1.10 in order to test things I made a [4 hour RimWorld video](https://www.youtube.com/watch?v=kivaRE3n7qU) using optimized 1080p settings, worked out at ~2.5GB/Hr for the files size. You can also see that at 1hr/2hr mark there the only seams I notice is a split second audio missing in each transition between recorded segments, after 2 hour 15mins, so nothing noticeably bad. 
...
### Credits
- Grok - Grok has gone Agentic, and was actually performing consistently well. This resulted in taking the program to next level effortlessly. 
